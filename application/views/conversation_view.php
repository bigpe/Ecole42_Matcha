...
<div id="main_site_block">
    ...
    if($users_data){
        foreach($users_data as $user_data) {
            ...
            print("<a href='/profile/view/?login=$login'>
                    <div class='people'><div class='user_photo' style='background: url($main_photo) no-repeat center; 
        ...
        print("<div id='system_message'><h2>Not Conversation Yet</h2></div>");?>
    </div>
</div>
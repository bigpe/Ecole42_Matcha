...
<div id="people_block">
    ...
    foreach($users_data as $user_data){
        ...
        <div class="message" style="'. $user_data['last_message'][0]['status_message']  .'"><a href="/conversation/chat_view/?id='.$user_data['chat_id'].'"><span >'.$user_data['last_message'][0]['author'].': '.$user_data['last_message'][0]['text_message'].'</span></a></div>');
    } ?>
</div>

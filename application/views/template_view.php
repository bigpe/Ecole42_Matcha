    ...
    <header>
        <div id="header_buttons">
            ...
            <?php if(isset($_SESSION['login']))
                $notify_message = $data['notification']['notification_message'];
            if(isset($_SESSION['login'])) $notify_events = $data['notification']['view_notification']?>
            ...
            <?php if(isset($_SESSION['login'])) print("<a class='header_buttons' href='/Conversation' id='conversation_icon'><i class=\"fas fa-envelope\"></i>");
            if(isset($_SESSION['login'])) $notify_message ? print("<span id='notification_mess'>$notify_message</span></a>") : print("</a>");?>
            <?php if(isset($_SESSION['login'])) print("<a class='header_buttons' id='notification' href='/History' id='notification_icon'><i class=\"fas fa-bell\"></i>");
